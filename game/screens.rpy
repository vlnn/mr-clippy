...
screen about():
    ...
    use game_menu(_("Про гру"), scroll="viewport"):
        ...
        vbox:
            label "Credits"
            text "Created to participate at Ukrainian Micro Visual Novel Jam"
            text "Written by: vlnn"
            text "Text editing by: OA, LF"
            text "Art by: vlnn, Microsoft (abandonware only)"
            text "Fonts by: AlphaBravo, ivancr72"
            text "Music by: Mystery Mammal"
            text "Sound effect by: vlnn"
...
screen credits():
    ...
    use game_menu(_("Credits")):
        vbox:
            label "Credits"
            text "Created for participation in Ukrainian Micro Visual Novel Jam"
            text "Written by: vlnn"
            text "Text editing by: OA, LF"
            text "Art by: vlnn, Microsoft (abandonware only)"
            text "Fonts by: AlphaBravo, ivancr72"
